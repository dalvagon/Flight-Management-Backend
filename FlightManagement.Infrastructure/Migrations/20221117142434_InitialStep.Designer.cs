...
namespace FlightManagement.Infrastructure.Migrations
{
    ...
    [Migration("20221117142434_InitialStep")]
            ...
            modelBuilder.Entity("FlightManagement.Business.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d826711a-de18-406c-96bc-4e084178f37b"),
            ...
            modelBuilder.Entity("FlightManagement.Business.Entities.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e941dfcd-89d4-4f50-bf8b-42e85d08e641"),
                        ...
                        new
                        {
                            Id = new Guid("cbfc427b-53df-4d86-b4f9-f6838d884ffe"),
