...
namespace FlightManagement.Infrastructure.Migrations
{
    ...
    [Migration("20221210172955_InitialStep")]
            ...
            modelBuilder.Entity("FlightManagement.Domain.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3abb77c4-5f48-4e56-853e-74b24d1c711e"),
                            CountryId = new Guid("584849e3-9ca3-4962-847d-38ce69e0f138"),
                            Name = "New York"
                        });
                });
            ...
            modelBuilder.Entity("FlightManagement.Domain.Entities.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("584849e3-9ca3-4962-847d-38ce69e0f138"),
                            Name = "Usa"
                        });
                });
